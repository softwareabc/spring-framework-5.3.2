...
public class ReflectiveMethodInvocation implements ProxyMethodInvocation, Cloneable {
	...
	public Object proceed() throws Throwable {
		...
		if (interceptorOrInterceptionAdvice instanceof InterceptorAndDynamicMethodMatcher) {
			...
			/* 普通拦截器，直接调用，比如：{@link org.springframework.aop.interceptor.ExposeInvocationInterceptor}
			 * {@link org.springframework.aop.support.DelegatePerTargetObjectIntroductionInterceptor}
			 ...
			 * {@link org.springframework.aop.aspectj.AspectJAfterAdvice}
			 */
